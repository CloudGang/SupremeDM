  ...
  render (){
    ...
    <div className="container">
      ...
      <section className="issues mt-5 text-center">
        ...
        <h4><a className="btn btn-primary prominent2" href="/upgrade" target="_blank">Try &nbsp;<b>SupremeDM Pro</b></a></h4>
      </section>
      <section className="row mt-5 justify-content-center">
        <div className="col-md-5">
          <h4>Issues running SupremeDM on your computer?</h4><span>Please see <a href="/blog/igdm-on-windows-linux" target="_blank">common issues and fixes </a>for running SupremeDM on your desktop.</span>
        </div>
